                            ...
                            <x-side-link href="{{ route('whatsapp.chat') }}" :active="request()->routeIs('whatsapp.chat*')" wire:navigate>
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="w-6 h-6"
                                    ...
                                    <path fill-rule="evenodd" clip-rule="evenodd"
                                        d="M12 2C6.477 2 2 6.477 2 12c0 1.891.524 3.66 1.438 5.168L2.05 21.55a.75.75 0 0 0 .9 1.002l4.492-1.325A9.956 9.956 0 0 0 12 22c5.523 0 10-4.477 10-10S17.523 2 12 2ZM4.092 12c0-4.367 3.541-7.908 7.908-7.908 4.367 0 7.908 3.541 7.908 7.908 0 4.367-3.541 7.908-7.908 7.908-1.572 0-3.037-.458-4.272-1.25l-.266-.17-2.825.833.856-2.736-.184-.285A7.873 7.873 0 0 1 4.092 12Zm11.08 3.668c-.23-.115-1.362-.672-1.573-.749-.211-.077-.365-.115-.519.115-.154.23-.595.749-.73.902-.134.154-.268.173-.498.058-.23-.115-.972-.358-1.852-1.143-.685-.61-1.147-1.363-1.282-1.594-.134-.23-.014-.355.101-.469.103-.103.23-.269.345-.403.115-.134.154-.23.23-.384.077-.154.038-.288-.019-.403-.058-.115-.519-1.248-.711-1.709-.187-.449-.377-.388-.519-.395l-.441-.008c-.154 0-.403.058-.614.288-.211.23-.806.787-.806 1.92 0 1.133.825 2.227.94 2.381.115.154 1.624 2.48 3.935 3.477.55.238.98.38 1.315.486.552.175 1.055.15 1.452.091.442-.066 1.362-.557 1.554-1.094.192-.538.192-.998.134-1.094-.057-.096-.211-.154-.441-.269Z" />
                                </svg>
