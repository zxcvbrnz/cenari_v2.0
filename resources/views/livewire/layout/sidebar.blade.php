            ...
            <ul x-data="{ menuOpen: {{ request()->routeIs('admin.create.*') ? 2 : (request()->routeIs('admin.data.*') ? 1 : (request()->routeIs('admin.jadwal.*') ? 3 : 'null')) }} }" class="space-y-2 font-medium">
                ...
                @if ($role == 'admin')
                    @if ($settingWhatsapp->value === 'ON')
                        <li>
                            <x-side-link href="{{ route('whatsapp') }}" :active="request()->routeIs('whatsapp*')" wire:navigate>
                                <!-- Icon WhatsApp -->
                                <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="w-6 h-6 shrink-0"
                                    viewBox="0 0 24 24">
                                    <path fill-rule="evenodd" clip-rule="evenodd"
                                        d="M12 2C6.48 2 2 6.48 2 12c0 1.82.49 3.53 1.34 5L2 22l5.12-1.32A9.94 9.94 0 0 0 12 22c5.52 0 10-4.48 10-10S17.52 2 12 2Zm0 18c-1.63 0-3.14-.44-4.45-1.2l-.32-.19-3.04.79.81-2.96-.21-.33A7.94 7.94 0 0 1 4 12c0-4.41 3.59-8 8-8s8 3.59 8 8-3.59 8-8 8Zm4.29-5.8c-.24-.12-1.42-.7-1.64-.78-.22-.08-.38-.12-.54.12-.16.24-.62.78-.76.94-.14.16-.28.18-.52.06-.24-.12-1.01-.37-1.93-1.19-.71-.63-1.19-1.42-1.33-1.66-.14-.24-.01-.37.11-.49.11-.11.24-.28.36-.42.12-.14.16-.24.24-.4.08-.16.04-.3-.02-.42-.06-.12-.54-1.3-.74-1.78-.2-.47-.39-.4-.54-.41l-.46-.01c-.16 0-.42.06-.64.3-.22.24-.84.82-.84 2 0 1.18.86 2.32.98 2.48.12.16 1.69 2.58 4.1 3.62.57.25 1.02.4 1.37.51.58.18 1.1.16 1.51.1.46-.07 1.42-.58 1.62-1.14.2-.56.2-1.04.14-1.14-.06-.1-.22-.16-.46-.28Z" />
                                </svg>
                    ...
                    <li>
                        <x-side-link href="{{ route('admin.laporan.keuangan') }}" :active="request()->routeIs('admin.laporan.keuangan')" wire:navigate>
                            <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                                class="w-6 h-6"viewBox="0 0 256 256">
                                <path
                                    d="M224,48H32A16,16,0,0,0,16,64V192a16,16,0,0,0,16,16H224a16,16,0,0,0,16-16V64A16,16,0,0,0,224,48Zm0,16V88H32V64Zm0,128H32V104H224v88Zm-16-24a8,8,0,0,1-8,8H168a8,8,0,0,1,0-16h32A8,8,0,0,1,208,168Zm-64,0a8,8,0,0,1-8,8H120a8,8,0,0,1,0-16h16A8,8,0,0,1,144,168Z">
