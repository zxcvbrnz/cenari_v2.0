...
<div class="w-full">
    <div
        class="w-full h-full bg-white shadow-lg border border-slate-200 rounded-sm px-8 py-6 flex flex-col justify-between sm:flex-row sm:items-center gap-4">
        <div>
            <span class="text-xl font-bold text-slate-500">{{ $kursus }}</span>
        </div>

        <!-- PEMBERITAHUAN LEBIH TEGAS -->
        <div
            class="inline-flex items-start sm:items-center gap-2 px-3 py-1.5 bg-amber-50 border border-amber-200 rounded text-xs text-amber-800 w-fit">
            <svg class="h-4 w-4 text-amber-600 shrink-0 mt-0.5 sm:mt-0" fill="none" viewBox="0 0 24 24"
                stroke="currentColor" stroke-width="2">
                <path stroke-linecap="round" stroke-linejoin="round"
                    d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z" />
            </svg>
            <span><strong>Informasi:</strong> Kursus ini hanya menerbitkan <strong>Sertifikat Digital
                    (E-Certificate)</strong> & tidak menyediakan bentuk fisik.</span>
        </div>
    </div>
</div>
