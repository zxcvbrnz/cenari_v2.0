        ...
        <div class="space-y-4">
            ...
            <div
                ...
                <div wire:loading wire:target="image"
                    class="absolute inset-0 bg-white/70 flex flex-col items-center justify-center z-10 rounded-lg">
            ...
            <button type="submit" wire:loading.attr="disabled"
                class="w-full inline-flex justify-center items-center px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white text-sm font-medium rounded-md shadow-sm transition disabled:opacity-50">
                Simpan Foto
            </button>
        </div>
