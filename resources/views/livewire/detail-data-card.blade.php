            ...
            <div class="p-4 flex justify-between items-center">
                <div class="flex items-center gap-3">
                    <a href="{{ route('dashboard') }}" wire:navigate
                        class="p-2 text-slate-500 hover:text-violet-600 hover:bg-slate-100 rounded-full transition-colors duration-200"
                        title="Kembali">
                    ...
                    <div class="text-xl font-semibold text-slate-700">
                        Data Peserta Didik - <span
                            class="text-violet-600">{{ ucfirst(str_replace('_', ' ', $status)) }}</span>
                    </div>
                </div>

                <div class="bg-slate-100 text-slate-600 px-3 py-1 rounded-full text-xs font-medium">
                    Total: {{ $peserta->count() }}
                </div>
            </div>
            <hr>
