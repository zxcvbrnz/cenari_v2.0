    ...
    <div class="max-w-xl mx-auto p-6 bg-white rounded-xl shadow-md border border-gray-100">
        ...
        <form wire:submit.prevent="save" class="space-y-5">
            ...
            <div class="p-4 bg-gray-50 rounded-lg border border-gray-200 space-y-4">
                ...
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-1">
                        Teks Baris Bawah Jam (Maks. 15 Karakter)
                    </label>
            ...
            <button type="submit" wire:loading.attr="disabled"
                class="w-full bg-blue-600 hover:bg-blue-700 disabled:bg-blue-400 text-white font-semibold py-2.5 px-4 rounded-md transition duration-200 flex justify-center items-center">
